          ...
          <div className="leftbox">
            <div className="leftb1">
              ...
              <div className="option">
                ...
                />
                <label htmlFor="option5">Fresh Fish</label>
              </div>
              <div className="option">
                <input
                  type="radio"
                  ...
                  defaultValue="option5"
                />
                <label htmlFor="option5">Meat Alternatives</label>
              </div>
              <div className="option">
                <input
                  type="radio"
            ...
            <div className="leftb1">
              ...
              <div className="option">
                <input
                  ...
                  defaultValue="option2"
                />
                <label htmlFor="option2">Black Leather</label>
              </div>
              <div className="option">
                <input
                  type="radio"
                  ...
                  defaultValue="option3"
                />
                <label htmlFor="option3">Black with Red</label>
              </div>
              <div className="option">
                <input
                  type="radio"
